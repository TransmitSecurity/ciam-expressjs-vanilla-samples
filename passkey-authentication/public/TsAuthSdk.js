(function (exports) {
  ...
  (function (ErrorCode) {
    ...
    ErrorCode['RegistrationStartFailed'] = 'registration_start_failed';
            ...
            case 1:
              ...
              if (!(response === null || response === void 0 ? void 0 : response.ok)) {
                throw makeSdkRejection(
                  ErrorCode.RegistrationStartFailed,
  ...
  var AuthenticationHandler = (function () {
    ...
    AuthenticationHandler.prototype.activateAutofill = function (params) {
      return __awaiter(this, void 0, void 0, function () {
        var onSuccess, onError, username, clientId, result, err_2, error;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
          ...
          switch (_a.label) {
            case 0:
              (username = params.username),
                ...
                (mediationType = params.mediationType);
              return [
                4,
            ...
            case 1:
              ...
              return [
                ...
                navigator.credentials.get(mediatedCredentialRequestOptions).catch(function (error) {
                  ...
                  throw makeSdkRejection(ErrorCode.Unknown, 'Something went wrong', {
                    error: error,
                  });
                }),
              ];
